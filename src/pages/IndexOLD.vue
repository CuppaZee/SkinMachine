  ...
  <q-page>
    ...
    >
      ...
      >
        ...
        <QRSkin skin="template:minizee/https://munzee.global.ssl.fastly.net/images/pins/morphobutterfly.png" :url="['sohcah','95','6OT6A4']"/>
        <QRSkin skin="template:rum/https://munzee.global.ssl.fastly.net/images/pins/negsreseller.png" :url="['sohcah','95','6OT6A4']"/>
        <!-- <q-select
          :dark="$store.state.DB.dark"
          outlined
          v-model="category"
      ...
      >
        ...
        <div class="row" v-if="type=='template'" style="max-height:calc(100vh - 318px - 40px);overflow-y:auto;">
